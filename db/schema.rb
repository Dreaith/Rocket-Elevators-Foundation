...
ActiveRecord::Schema.define(version: 2021_12_01_180458) do
  ...
  create_table "fact_interventions", options: "CREATE TABLE \"fact_interventions\" (\n  \"id\" bigint NOT NULL AUTO_INCREMENT,\n  \"employee_id\" bigint DEFAULT NULL,\n  \"building_id\" bigint DEFAULT NULL,\n  \"battery_id\" bigint DEFAULT NULL,\n  \"column_id\" bigint DEFAULT NULL,\n  \"elevator_id\" bigint DEFAULT NULL,\n  \"start_intervention\" date DEFAULT NULL,\n  \"end_intervention\" date DEFAULT NULL,\n  \"result\" varchar(255) DEFAULT NULL,\n  \"report\" varchar(255) DEFAULT NULL,\n  \"status\" varchar(255) DEFAULT NULL,\n  \"created_at\" datetime NOT NULL,\n  \"updated_at\" datetime NOT NULL,\n  PRIMARY KEY (\"id\"),\n  KEY \"index_fact_interventions_on_employee_id\" (\"employee_id\"),\n  KEY \"index_fact_interventions_on_building_id\" (\"building_id\"),\n  CONSTRAINT \"fk_rails_402276bba9\" FOREIGN KEY (\"employee_id\") REFERENCES \"employees\" (\"id\"),\n  CONSTRAINT \"fk_rails_ddddca75db\" FOREIGN KEY (\"building_id\") REFERENCES \"buildings\" (\"id\")\n)", force: :cascade do |t|
    t.bigint "employee_id"
    t.bigint "building_id"
    t.bigint "battery_id"
    t.bigint "column_id"
